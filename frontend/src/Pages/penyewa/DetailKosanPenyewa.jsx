  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        <div className="bg-white h-[1563px] flex justify-center w-full">
                  ...
                  <div className="flex flex-col ml-3">
                    <div className="flex w-[657px] h-[48px] top-[57px] left-[55px]">
                      <p className="flex w-[575px] top-0 left-0 [font-family:'Poppins-Regular',Helvetica] font-normal text-[#000000cc] text-[16px] text-justify tracking-[0] leading-[normal]">
                        Jl. Telang Indah III 3, Perumahan Telang Indah, Telang,
                    ...
                    <div className="flex flex-row w-[442px]">
                      ...
                      <div className="flex flex-col my-2 ml-3 w-[626px] [font-family:'Poppins-Regular',Helvetica] font-normal text-black text-[16px] text-justify tracking-[0] leading-[normal]">
                        ...
                        <ul className="mb-2 w-[426px]">
                          Jl. Telang Indah III 3, Perumahan Telang Indah No.
                          H24, Telang, Kec. Kamal, Kabupaten Bangkalan, Jawa
                          Timur 69162
                        </ul>
                      </div>
                    </div>
                ...
                <div className="flex flex-col w-[962px] [font-family:'Poppins-Medium',Helvetica] font-medium text-black text-[24px] text-justify tracking-[0] leading-[normal]">
                  ...
                  <div className="flex flex-row mt-5 justify-between">
                    <div className="flex flex-col">
                      ...
                      <div className="flex mb-9 ml-3">
                        <div className="flex flex-col text-[16px]">
                          <li className="my-0.5">Kipas Angin </li>
                          <li className="my-0.5">Springbed</li>
                          <li className="my-0.5">Bantal Dan Guling</li>
                          <li className="my-0.5">Lemari</li>
                          <li className="my-0.5">Rak Tv</li>
                          <li className="my-0.5">Meja Belajar</li>
                          <li className="my-0.5">Satu Kamar Bisa dua orang</li>
                          <li className="my-0.5">Loker Sepatu</li>
                          <li className="my-0.5">Air sanyo</li>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col mr-[138px]">
                      ...
                      <div className="flex mb-9 ml-3">
                        <div className="flex flex-col text-[16px]">
                          <li className="my-0.5">Parkiran Motor/Mobil </li>
                          <li className="my-0.5">Kamar Mandi</li>
                          <li className="my-0.5">Dapur</li>
                          <li className="my-0.5">Tempat Jemur Baju</li>
                          <li className="my-0.5">Wi-fi</li>
                          <li className="my-0.5">Rak Helm</li>
                          <li className="my-0.5">Ruang Tamu</li>
                          <li className="my-0.5">Ruang Tv</li>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-2 text-[16px]">
                    300 meter dari Universitas Trunojoyo Madura ke arah barat,
                    sampai di gang Warung Mawar belok ke arah Selatan, lalu
                    tepat di Perumahan Telang Indah Barat Gg. lll belok ke arah
                    barat, kos menghadap ke utara tepat di depan rumah RT. 02
                    Perumahan Telang Indah.
                    <br />
                    <br />
                  </div>
...
export default DetailKosanPenyewa;
